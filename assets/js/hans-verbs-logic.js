(function () {
  const data = window.hansVerbsData;
  ...
  function initHansVerbs() {
    ...
    if (!box.dataset.initialized) {
      ...
      box.dataset.lesson = "verbs";
    }
  }

  window.askHansChat = askHansChat;
  window.sendHansMessage = sendHansMessage;
  window.initHansVerbs = initHansVerbs;

  document.addEventListener("DOMContentLoaded", initHansVerbs);
})();