(function () {
  const data = window.hansListeningData;
  ...
  function initHansListening() {
    ...
    if (!box.dataset.initialized) {
      ...
      box.dataset.lesson = "listening";
    }
  }

  window.askHansChat = askHansChat;
  window.sendHansMessage = sendHansMessage;
  window.initHansListening = initHansListening;

  document.addEventListener("DOMContentLoaded", initHansListening);
})();